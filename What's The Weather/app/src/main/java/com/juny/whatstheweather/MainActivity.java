package com.juny.whatstheweather;
    ...
    public class DownloadTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                String weatherIfno = jsonObject.getString("weather");

                Log.i("Weather content", weatherIfno);

                JSONArray arr = new JSONArray(weatherIfno);
